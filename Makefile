...
CONSOLESELECTORSOURCES=$(wildcard SystemController/*.cpp) $(wildcard AllNeeded/*.cpp) $(Comminucation.cpp)
CONSOLESELECTORHEADERS=$(wildcard SystemController/*.h) $(wildcard AllNeeded/*.h)
CONSOLESELECTOROBJECTS=$(SOURCES:.cpp=.o)
CONSOLESELECTORTARGET=ConsoleSelector

REMOTECONTROLLERSOURCES=$(wildcard RemoteController/*.cpp) $(wildcard AllNeeded/*.cpp) $(Comminucation.cpp)
REMOTECONTROLLERHEADERS=$(wildcard RemoteController/*.h) $(wildcard AllNeeded/*.h)
